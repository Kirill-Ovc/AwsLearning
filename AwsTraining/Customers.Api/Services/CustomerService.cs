...
public class CustomerService : ICustomerService
{
    ...
    private readonly ISqsMessaging _sqsMessaging;

    public CustomerService(ICustomerRepository customerRepository, 
        IGitHubService gitHubService, 
        ISqsMessaging sqsMessaging)
    {
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _sqsMessaging.SendMessageAsync(customer.ToCustomerCreatedMessage());
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _sqsMessaging.SendMessageAsync(customer.ToCustomerUpdatedMessage());
        }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if (response)
        {
            await _sqsMessaging.SendMessageAsync(new CustomerDeleted { Id = id });
        }
